...
def paintability(
    ...
    *,
    ...
    ``min_label_radius``. Iterating ``np.unique`` instead of the palette is
    equivalent — label_img holds exactly the 0-based palette indices — and
    keeps the metric usable without building a palette first.
    """
